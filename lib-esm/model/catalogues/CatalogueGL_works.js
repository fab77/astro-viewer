...
class CatalogueGL {
    ...
    draw(in_mMatrix, in_mouseHelper) {
        ...
        this.gl.bindBuffer(this.gl.ARRAY_BUFFER, this.vertexCataloguePositionBuffer);
        // positions
        this.gl.vertexAttribPointer(this.attribLocations.position, 3, this.gl.FLOAT, false, CatalogueGL.BYTES_X_ELEM * CatalogueGL.ELEM_SIZE, 0);
        this.gl.enableVertexAttribArray(this.attribLocations.position);
        // hovered flag
        this.gl.vertexAttribPointer(this.attribLocations.hovered, 1, this.gl.FLOAT, false, CatalogueGL.BYTES_X_ELEM * CatalogueGL.ELEM_SIZE, CatalogueGL.BYTES_X_ELEM * 3);
        this.gl.enableVertexAttribArray(this.attribLocations.hovered);
        // point size
        this.gl.vertexAttribPointer(this.attribLocations.pointSize, 1, this.gl.FLOAT, false, CatalogueGL.BYTES_X_ELEM * CatalogueGL.ELEM_SIZE, CatalogueGL.BYTES_X_ELEM * 4);
        this.gl.enableVertexAttribArray(this.attribLocations.pointSize);
        // brightness
        this.gl.vertexAttribPointer(this.attribLocations.brightness, 1, this.gl.FLOAT, false, CatalogueGL.BYTES_X_ELEM * CatalogueGL.ELEM_SIZE, CatalogueGL.BYTES_X_ELEM * 5);
...
//# sourceMappingURL=CatalogueGL_works.js.map