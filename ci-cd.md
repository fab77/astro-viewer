...
git commit -m "Prepare release 3.3.0"

git push -u origin release/3.3.0
```
Open PR `release/3.3.0 -> main` in GitHub and merge on `main`.
...
npm version 3.4.0-snapshot --no-git-tag-version
npm install

git add package.json package-lock.json
git commit -m "Start 3.4.0-snapshot development"
git push origin dev
```
