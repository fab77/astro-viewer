...
npm version 3.5.1 --no-git-tag-version
npm install
npm run build
...
git commit -m "Prepare release 3.5.1"

git push -u origin release/3.5.1
```
Open PR `release/3.5.1 -> main` in GitHub and merge on `main`.
...
```bash
npm view @fab77/astro-viewer@3.5.1 --registry=https://npm.pkg.github.com
...
npm install @fab77/astro-viewer@3.5.1
